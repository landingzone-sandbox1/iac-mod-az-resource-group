...
| <a name="input_fallback_environment"></a> [fallback\_environment](#input\_fallback\_environment) | Fallback environment when naming.environment is null. Must be one of: D, T, P, F. | `string` | `"D"` | no |
