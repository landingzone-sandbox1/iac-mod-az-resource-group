...
module "log_analytics" {
  ...
  source = "git::https://github.com/landingzone-sandbox1/iac-mod-az-log-analytics.git?ref=main"
...
module "storage_account" {
  ...
  # For production, use:
  # tflint-ignore: terraform_module_pinned_source
  source = "git::https://github.com/landingzone-sandbox1/iac-mod-az-storage-account.git?ref=main"
...
module "key_vault" {
  ...
  # For production, use:
  # tflint-ignore: terraform_module_pinned_source
  source = "git::https://github.com/landingzone-sandbox1/iac-mod-az-key-vault.git?ref=main"
